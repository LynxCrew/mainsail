<template>
    <div v-if="useFluiddViewer">
        <FluiddViewer></FluiddViewer>
    </div>
    <div v-else>
        <MainsailViewer></MainsailViewer>
    </div>
</template>
...
export default class Viewer extends Mixins(BaseMixin) {
    ...
    get useFluiddViewer() {
        ...
        return (this.$store.state.gui.gcodeViewer.useFluiddViewer ?? false) && (fluiddURL != '' || fluiddPort != '')
    }
}
</script>
