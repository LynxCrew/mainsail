...
export default class ToolheadControlPanel extends Mixins(BaseMixin, ControlMixin) {
    ...
    get showButtons() {
        return (this.controlStyle !== 'bars' &&
                ((this.existsZtilt || this.existsQGL) && (!this.lynxLayout || (this.actionButton !== 'ztilt' && this.actionButton !== 'qgl')))) ||
                this.existsBedScrews ||
                this.existsBedTilt ||
                this.existsDeltaCalibrate ||
                this.existsScrewsTilt
    }
}
</script>
